...
[Migration("20250521132636_AddedTeamCaptain")]
partial class AddedTeamCaptain
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("Mercurius.LAN.API.Models.Match", b =>
            {
                ...
                b.HasOne("Mercurius.LAN.API.Models.Team", "Team1")
                    .WithMany()
                    .HasForeignKey("Team1Id")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Mercurius.LAN.API.Models.Team", "Team2")
                    .WithMany()
                    .HasForeignKey("Team2Id")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Mercurius.LAN.API.Models.Team", "Winner")
                    .WithMany()
