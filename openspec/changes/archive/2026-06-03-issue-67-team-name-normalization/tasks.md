...
- [x] 1.3 Create a migration that backfills normalized names and updates the snapshot.
...
- [x] 2.3 Catch database unique constraint violations and return safe validation errors.
- [x] 2.4 Add normalized lookup helpers for public team profile and search features.

## 3. Regression Coverage

- [x] 3.1 Add tests for duplicate create and update across casing.
- [x] 3.2 Add tests for normalized lookup and search behavior.
- [x] 3.3 Add tests for invalid names and migration/backfill expectations.
