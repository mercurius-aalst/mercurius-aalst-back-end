...
public class GetPublicTeamMemberDTO
{
    ...
    public GetPublicTeamMemberDTO()
    {
    }

    public GetPublicTeamMemberDTO(User user, bool includePlatformIds = false)
    {
        Id = user.Id;
    ...
    public GetPublicTeamMemberDTO(GetTeamUserDTO user, bool includePlatformIds = false)
    {
        Id = user.Id;
        DisplayName = user.DisplayName;
        Username = NormalizeUsername(user.Username, user.DisplayName);
