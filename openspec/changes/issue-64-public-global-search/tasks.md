...
- [ ] 1.1 Add search response and result DTOs with `results`, `nextCursor`, count/more metadata, type, labels, and navigation fields.
...
- [ ] 2.5 Apply bounded page size, deterministic relevance ordering, cursor continuation, and projection-only DTO mapping.

## 3. Regression Coverage

- [ ] 3.1 Add tests for user, team, game, empty, short-query, case-insensitive results, relevance ordering, and cursor continuation.
