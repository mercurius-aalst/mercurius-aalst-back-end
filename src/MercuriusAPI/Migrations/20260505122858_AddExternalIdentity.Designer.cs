...
namespace Mercurius.LAN.API.Migrations
{
    ...
    [Migration("20260505122858_AddExternalIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Module.Models.AuthUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Auth.Module.Models.ExternalIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Auth.Module.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Auth.Module.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Auth.Module.Models.ExternalIdentity", b =>
                {
                    b.HasOne("Auth.Module.Models.AuthUser", "User")
            ...
            modelBuilder.Entity("AuthUserRole", b =>
                {
                    b.HasOne("Auth.Module.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Auth.Module.Models.AuthUser", null)
                        .WithMany()
