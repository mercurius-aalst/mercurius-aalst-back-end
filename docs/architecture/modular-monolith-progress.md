...
- Current phase branch: `refactor/phase-1`
- Current PR: [#94 Phase 1: document modular monolith guardrails](https://github.com/mercurius-aalst/mercurius-aalst-back-end/pull/94)
- PR target: `refactor/modular-monolith`
- State: opened and ready for human review
- Next action: wait for PR #94 to merge, then update local `refactor/modular-monolith` and start Phase 2 from it.
...
| --- | --- | --- | --- | --- |
| 1. AGENTS.md guardrails and refactor branch setup | `refactor/phase-1` | In review | [#94](https://github.com/mercurius-aalst/mercurius-aalst-back-end/pull/94) | Documentation/guardrails only. No behavior change. |
